  ...
  return (
    <div className="w-full max-w-4xl mx-auto pt-32 pb-16 px-4">
      ...
      <div className="relative space-y-12">
        {/* Vertical Line */}
        <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-[2px] bg-neutral-800 -ml-[1px]" />
        ...
        {data.map((item, index) => (
          ...
          >
            {/* Dot */}
            <div className="absolute left-4 md:left-1/2 w-4 h-4 rounded-full bg-neutral-700 border-4 border-neutral-950 -ml-2 mt-2 z-10" />
