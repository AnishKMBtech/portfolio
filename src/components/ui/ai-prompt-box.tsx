          ...
          >
            ...
            <div className="flex items-center">
              ...
              >
                ...
                {showSearch && <span className="text-xs text-[#1EAEDB]">Search</span>}
              </button>
              ...
              >
                ...
                {showThink && <span className="text-xs text-[#8B5CF6]">Think</span>}
              </button>
              ...
              >
                ...
                {showCanvas && <span className="text-xs text-[#F97316]">Canvas</span>}
              </button>
            </div>
          </div>
