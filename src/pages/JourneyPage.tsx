...
const DualBootScreen = () => (
  <div className="w-full h-full bg-[#1a1a1a] flex flex-col font-sans overflow-hidden">
    <div className="flex-1 grid grid-cols-2 gap-px bg-white/5">
      <div className="bg-[#0078D7] flex flex-col items-center justify-center p-4 border-r border-white/10">
        <div className="text-white font-bold text-lg mb-2">Windows 11</div>
        <div className="text-white/60 text-[10px] text-center">Daily Driver</div>
      </div>
      <div className="bg-[#0c0c0c] flex flex-col items-center justify-center p-4">
        <div className="text-emerald-500 font-bold text-lg mb-2">Arch Linux</div>
        <div className="text-emerald-500/60 text-[10px] text-center">AI Development</div>
      </div>
    </div>
    <div className="h-8 bg-black flex items-center justify-center text-[10px] text-zinc-500 font-mono">
      GRUB v2.06 Dual Boot Loader
...
const JourneySection = ({ 
  ...
  return (
    <section id={id} className="min-h-screen flex flex-col items-center justify-center py-24 px-6 relative overflow-hidden">
    ...
    const ArchLoader = () => {
      ...
      return (
        <div className="w-full h-full flex items-center justify-center p-6">
          {!started ? (
            <div className="text-center">
              <div className="mb-4 text-zinc-300">Arch Linux environment preview</div>
              <button
                onClick={() => setStarted(true)}
                className="px-6 py-3 rounded-full bg-emerald-500 text-black font-semibold hover:opacity-90"
              >
                Load Environment
              </button>
            </div>
