  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div className="bg-zinc-800/50 p-6 rounded-2xl border border-zinc-700/50 space-y-6">
          ...
          <p className="text-zinc-100 dark:text-white text-base md:text-lg font-normal mb-0 leading-relaxed">
            AI & ML Intern (Product and Research), ISMO Bio-Photonics, IIT Madras Research Park — Aug 2025 - Oct 2025.
          </p>
          <p className="text-zinc-100 dark:text-white text-base md:text-lg font-normal mb-0 leading-relaxed">
            Internship Trainee — Nokia Research, SRM Centre of Excellence — Nov 2025 - Jan 2026.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="bg-zinc-800/50 p-6 rounded-2xl border border-zinc-700/50 space-y-6">
          <p className="text-zinc-100 dark:text-white text-base md:text-lg font-normal mb-0 leading-relaxed">
            Attended the GDG event at Ford Business Solutions, working hands-on with Multi-Agent Systems, LLM reasoning modules, and cloud deployment. Explored MCP (Model Context Protocol) and ADK (Agent Development Kit) architectures to build sophisticated agent workflows and A2A (Agent-to-Agent) orchestrators.
          </p>
          <p className="text-zinc-100 dark:text-white text-base md:text-lg font-normal mb-0 leading-relaxed">
            Started advanced Python and databases, exploring systems design and architecture while maintaining a strong focus on AI orchestration and remote agent engines.
          </p>
        </div>
      ),
    },
